...
- State is process-local: up to 1024 conversations, 1024 signature entries, 1024 opaque call records, and 4096 model quota observations. Replay expires after 30 minutes; conversation idle expiry is 30 minutes; quota observations expire after one minute.
